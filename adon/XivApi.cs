...
namespace FakeMark
{
    internal class XivApi : IDisposable
    {
        ...
        private XivApi(DalamudPluginInterface pluginInterface, PluginAddressResolver address)
        {
            ...
            DalamudApi.ClientState.Logout += OnLogout_ResetRaptureAtkModule;
        ...
        internal static IntPtr RaptureAtkModulePtr
        {
            get
            {
                ...
                {
                    var frameworkPtr =DalamudApi.Framework.Address.BaseAddress;
        ...
        internal static bool IsLocalPlayer(int actorID) => DalamudApi.ClientState.LocalPlayer?.ObjectId == actorID;
        ...
        internal class SafeAddonNamePlate
        {
            ...
            public IntPtr Pointer =>DalamudApi.GameGui.GetAddonByName("NamePlate", 1);
